    ...
    <Card>
      <form className={classes.form} onSubmit={submitHandler}>
        ...
        <div className={classes.control}>
          ...
          <input type='text' required id='contact' value= {contact} onChange={(e)=>setContact(e.target.value)} />
        </div>
        <div className={classes.control}>
          <label htmlFor='author'>Art-owner</label>
          <input type='text' required id='author' value= {author} onChange={(e)=>setAuthor(e.target.value)} />
        </div>
        <div className={classes.control}>
          <label htmlFor='description'>Description</label>
          <textarea id='description' required rows='5' value= {desc} onChange={(e)=>setDesc(e.target.value)}></textarea>
        </div>
